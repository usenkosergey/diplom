...
public class ApiGeneralController {
    ...
    public ResponseEntity<ResponseAll> profile(
            @RequestParam(value = "photo", required = false) MultipartFile uploadfile,
            @RequestParam(name = "removePhoto", required = false) boolean removePhoto,
        ...
        if (uploadfile != null) System.out.println(uploadfile.getSize());
        System.out.println(removePhoto + " removePhoto");
